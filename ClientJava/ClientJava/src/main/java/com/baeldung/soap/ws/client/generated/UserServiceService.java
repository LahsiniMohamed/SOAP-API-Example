 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://Services.com.example2/", wsdlLocation = "http://localhost:8000/service/soap?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://Services.com.example2/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8000/service/soap?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://Services.com.example2/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Services.com.example2/", "UserServicePort"), UserService.class, features);
    }
